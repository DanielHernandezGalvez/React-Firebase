...
export default function TablaEmpresas({ iconPrimary, primary, secondary, secondarySub, color, bgcolor }) {
    ...
    <>
      <Grid item xs={12}>
        <Card sx={{ bgcolor: bgcolor || '', position: 'relative' }}>
          ...
          {console.log(check)}
          {check === 'laboratorio' && <DataTable data={dataLab} columns={columnsLaboratorio} responsive="true" pagination fixedHeader />}
        </Card>
      </Grid>
        ...
        <Grid item xs={12}>
          <Grid container spacing={gridSpacing}>
            <Card sx={{ bgcolor: bgcolor || '', position: 'relative', paddingTop: '10px' }}>
              <DataTable data={dataImg} columns={columnsLaboratorio} responsive="true" pagination fixedHeader />
            </Card>
          </Grid>
        </Grid>
      )}
