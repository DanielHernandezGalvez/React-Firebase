    ...
    >
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          ><i className="bi bi-buildings pe-2 fs-3"></i>
            Empresa
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          >
            <i className="bi bi-clipboard-data pe-2 fs-3"></i>
            Administración
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          >
            <i className="bi bi-person-bounding-box pe-2 fs-3"></i>
            Dirección
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          <button
            ...
            aria-controls='collapseThree'
          >
            <i className="bi bi-clipboard2-check pe-2 fs-3"></i>
            Encuesta
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          <button
            ...
            aria-controls='collapseThree'
          >
            <i className="bi bi-person-add pe-2 fs-3"></i>
            Productividad
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          >
            <i className="bi bi-graph-up-arrow pe-2 fs-3"></i>
            Estadisticos
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          > 
            <i className="bi bi-tools pe-2 fs-3"></i>
            Utilerías
          </button>
        </h2>
        <div
      ...
      <div className='accordion-item border border-0'>
        <h2 className='accordion-header border border-0'>
          ...
          >
            <i className="bi bi-gear-wide-connected pe-2 fs-3"></i>
            Configuración
          </button>
        </h2>
        <div
